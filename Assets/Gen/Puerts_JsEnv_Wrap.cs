...
namespace PuertsStaticWrap
{
    public static class Puerts_JsEnv_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_ArgumentsPusher(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.JsEnv;
                var result = obj.ArgumentsPusher;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_ArgumentsPusher(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.JsEnv;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.ArgumentsPusher = argHelper.Get<Puerts.PushJSFunctionArgumentsCallback>(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"ArgumentsPusher", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_ArgumentsPusher, Setter = S_ArgumentsPusher} },
