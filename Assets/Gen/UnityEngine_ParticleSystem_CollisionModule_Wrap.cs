...
namespace PuertsStaticWrap
{
    public static class UnityEngine_ParticleSystem_CollisionModule_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_maxPlaneCount(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.ParticleSystem.CollisionModule)Puerts.Utils.GetSelf((int)data, self);
                var result = obj.maxPlaneCount;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"maxPlaneCount", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_maxPlaneCount, Setter = null} }
                },
