...
namespace PuertsStaticWrap
{
    public static class UnityEngine_QualitySettings_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_blendWeights(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_blendWeights(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.QualitySettings.blendWeights = (UnityEngine.BlendWeights)argHelper.GetInt32(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_streamingMipmapsRenderersPerFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var result = UnityEngine.QualitySettings.streamingMipmapsRenderersPerFrame;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_streamingMipmapsRenderersPerFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.QualitySettings.streamingMipmapsRenderersPerFrame = argHelper.GetInt32(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"blendWeights", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_blendWeights, Setter = S_blendWeights} },
                    ...
                    {"streamingMipmapsRenderersPerFrame", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_streamingMipmapsRenderersPerFrame, Setter = S_streamingMipmapsRenderersPerFrame} },
