...
namespace PuertsStaticWrap
{
    public static class UnityEngine_ParticleSystem_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetSafeCollisionEventSize(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ParticleSystem;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetCollisionEvents(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ParticleSystem;
        
                {
                ...
                
                    {
                        ...
                        var Arg1 = argHelper1.Get<System.Collections.Generic.List<UnityEngine.ParticleCollisionEvent>>(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetSafeTriggerParticlesSize(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ParticleSystem;
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = (UnityEngine.ParticleSystemTriggerEventType)argHelper0.GetInt32(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetTriggerParticles(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ParticleSystem;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetTriggerParticles(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ParticleSystem;
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>), false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false))
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    ...
                    { new Puerts.MethodKey { Name = "GetSafeCollisionEventSize", IsStatic = false}, M_GetSafeCollisionEventSize },
                    { new Puerts.MethodKey { Name = "GetCollisionEvents", IsStatic = false}, M_GetCollisionEvents },
                    { new Puerts.MethodKey { Name = "GetSafeTriggerParticlesSize", IsStatic = false}, M_GetSafeTriggerParticlesSize },
                    { new Puerts.MethodKey { Name = "GetTriggerParticles", IsStatic = false}, M_GetTriggerParticles },
                    { new Puerts.MethodKey { Name = "SetTriggerParticles", IsStatic = false}, M_SetTriggerParticles }
                },
