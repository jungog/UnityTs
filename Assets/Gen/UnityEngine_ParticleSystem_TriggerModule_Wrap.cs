...
namespace PuertsStaticWrap
{
    public static class UnityEngine_ParticleSystem_TriggerModule_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_maxColliderCount(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.ParticleSystem.TriggerModule)Puerts.Utils.GetSelf((int)data, self);
                var result = obj.maxColliderCount;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"maxColliderCount", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_maxColliderCount, Setter = null} }
                },
