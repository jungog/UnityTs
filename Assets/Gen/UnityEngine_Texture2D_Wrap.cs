...
namespace PuertsStaticWrap
{
    public static class UnityEngine_Texture2D_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_EncodeToTGA(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture2D;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_EncodeToPNG(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture2D;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_EncodeToJPG(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture2D;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_EncodeToEXR(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture2D;
            ...
            
                {
                ...
                
                    {
                        ...
                        var Arg0 = (UnityEngine.Texture2D.EXRFlags)argHelper0.GetInt32(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_LoadImage(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture2D;
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(byte[]), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_alphaIsTransparency(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture2D;
                var result = obj.alphaIsTransparency;
                Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_alphaIsTransparency(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture2D;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.alphaIsTransparency = argHelper.GetBoolean(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    ...
                    { new Puerts.MethodKey { Name = "EncodeToTGA", IsStatic = false}, M_EncodeToTGA },
                    { new Puerts.MethodKey { Name = "EncodeToPNG", IsStatic = false}, M_EncodeToPNG },
                    { new Puerts.MethodKey { Name = "EncodeToJPG", IsStatic = false}, M_EncodeToJPG },
                    { new Puerts.MethodKey { Name = "EncodeToEXR", IsStatic = false}, M_EncodeToEXR },
                    { new Puerts.MethodKey { Name = "LoadImage", IsStatic = false}, M_LoadImage }
                },
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"alphaIsTransparency", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_alphaIsTransparency, Setter = S_alphaIsTransparency} }
                },
